...
class AsteriskController extends Controller
{
    ...
    public function asterisk2_status()
    {
        $status = DB::connection('asterisk2')->table('report')->orderBy('id', 'desc')->limit(1)->first();
    ...
    public function asterisk2_sessionsmovistar()
    {
        $sessions_calls = DB::connection('asterisk2')->table('sessions_movistar')->orderBy('id', 'desc')->limit(1)->first();

    ...
    */
    ...
    'connections' => [
        ...
        'magnusbilling' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_MAGNUSBILLING', '127.0.0.1'),
            'port' => env('DB_PORT_MAGNUSBILLING', '3306'),
            'database' => env('DB_DATABASE_MAGNUSBILLING', 'forge'),
            'username' => env('DB_USERNAME_MAGNUSBILLING', 'forge'),
            'password' => env('DB_PASSWORD_MAGNUSBILLING', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'latin1',
            'collation' => 'latin1_swedish_ci',
            'prefix' => '',
        ...
        'asterisk.portables' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PORTABLES', '127.0.0.1'),
            'port' => env('DB_PORT_PORTABLES', '3306'),
            'database' => env('DB_DATABASE_PORTABLES', 'forge'),
            'username' => env('DB_USERNAME_PORTABLES', 'forge'),
            'password' => env('DB_PASSWORD_PORTABLES', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8',

                ...
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="table-responsive card-body">
                            <table id="inboundaccesscharges" class="table table-bordered table-hover table-striped dt-responsive display nowrap mb-0" cellspacing="0" width="100%">
...
$(document).ready(function(){
    ...
    let revenuesTable = $('#inboundaccesscharges').DataTable({
        processing: true,
        serverSide: true,
        scrollX: true,
        language:{ url: SITEURL + 'datatables/spanish' },
        ajax: { url: SITEURL + 'cargosdeacceso/entrantes', type: 'GET' },
        columns: [
            {data: 'date', name: 'date'},
    ...
    $('body').on('click', '.download', function () {
        ...
        window.location = SITEURL + 'cargosdeacceso/entrantes/download/'+ file_id
    });
})
</script>
@endpush
    ...
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td align="center" class="bodycopy">
                Se hace entrega del {{ $data['revenues_date'] }}, si tiene algún problema contáctese con el
    ...
    <tr>
        <td class="innerpadding borderbottom bodycopy" align="center">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr align="center">
                    <td><span style="margin-right: 0.5em; font-weight: bold;">$</span>{{ number_format($data['account_state'], 2, ',', '.' ) }}</td>
                </tr>
            </table>
        </td>
    </tr>

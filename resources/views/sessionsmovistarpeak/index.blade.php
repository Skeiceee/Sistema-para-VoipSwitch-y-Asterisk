            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div><i class="fas fa-wallet"></i><span class="font-weight-bold ml-2">Reporte diario de sesiones de Movistar</span></div>
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div><i class="fas fa-layer-group"></i><span class="font-weight-bold ml-2">Consumos acumulados y cargos recurrentes</span></div>
                                    </div>
                                    <hr class="my-3">
